...
- Türkçe ve İngilizce arayüz; ilk açılışta cihaz diline göre otomatik seçim
...
3. **Firestore Database**'i oluşturun. Bu depo, üretime hazır güvenlik kurallarını
   (`firestore.rules`) zaten içeriyor; birazdan 6. adımda bunları yayınlayacaksınız.
...
- İngilizce çeviri hızlı ve test amaçlı yapılmıştır; klinik terminoloji tıbbi bir
  incelemeden geçmemiştir. Bir alan uzmanı doğrulayana kadar İngilizce arayüz taslak
  kabul edilmelidir.
